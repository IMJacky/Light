...
mysql -u root -p
use mysql
alter user 'root'@'10.102.40.72' identified by 'your pwd' password expire never
alter user 'root'@'10.102.40.72' identified with mysql_native_password by 'your pwd'
flush privileges